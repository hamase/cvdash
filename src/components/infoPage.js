					...
					<Col md={12} className="right_box">
						<Col md={12} className="info_box">
							...
							<div className="info_box--desc">
								...
								<h5>
									I'm Front-end Developer, i enjoy to learn everything and use
									that in my projects. <br />I learning every thing self study.
									I started my work in 2013 in worked with Selenium, Python,
									HTML and CSS. <br />
									After that i worked as seriously with JQuery and JavaScript.
									worked as freelance more than a year. <br />
									Then worked in GSS with JavaScript, JSX, Extjs, JSF <br />
